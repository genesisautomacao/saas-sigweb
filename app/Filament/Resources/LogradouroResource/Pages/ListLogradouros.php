    ...
    protected function getHeaderActions(): array
    {
        return [
            Actions\ActionGroup::make([
                ...
                Actions\Action::make('export_csv')->label('Exportar CSV')->icon('heroicon-o-document')
                    ->action(fn (LogradouroExportService $service) => $service->exportToCsv($this->getFilteredTableQuery()->get())),
