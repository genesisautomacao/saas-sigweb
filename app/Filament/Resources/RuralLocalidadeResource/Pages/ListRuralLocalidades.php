        ...
        return [
            Actions\ActionGroup::make([
                ...
                Actions\Action::make('export_csv')
                    ...
                    ->action(fn ($livewire, \App\Services\Exports\RuralLocalidadeExportService $s) => $s->exportToCsv($livewire->getFilteredTableQuery()->get())),

                Actions\Action::make('export_xml')
                    ->label('Exportar XML')
                    ->icon('heroicon-o-code-bracket')
                    ->action(fn ($livewire, \App\Services\Exports\RuralLocalidadeExportService $s) => $s->exportToXml($livewire->getFilteredTableQuery()->get())),
            ])
            ->label('Exportar')
