...
class EditRole extends EditRecord
{
    ...
    protected function mutateFormDataBeforeFill(array $data): array
    {
        ...
        // 🟢 NOVA LINHA DO RURAL PARA CARREGAR NO FORMULÁRIO DE EDIÇÃO
    ...
    protected function mutateFormDataBeforeSave(array $data): array
    {
        ...
        // 🟢 ATUALIZADO (Adicionado $rural no array_merge)
        $this->permissionsToSync = array_merge($users, $roles, $pessoas, $contatos, $enderecos, $documentos, $iluminacao, $arborizacao, $estoque, $manutencao, $cemiterio, $imobiliario, $social, $rural);
        ...
        unset(
            ...
            $data['permissions_rural'] // 🟢 NOVA LINHA
        );
