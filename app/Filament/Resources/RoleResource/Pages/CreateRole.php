...
class CreateRole extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $manutencaoData = $data['permissions_manutencao'] ?? []; // NOVO
        ...
        $manutencao = is_array($manutencaoData) ? $manutencaoData : ($manutencaoData === true ? ['view_solicitacoes', 'create_solicitacoes', 'edit_solicitacoes', 'delete_solicitacoes', 'view_ordens_servico', 'create_ordens_servico', 'edit_ordens_servico', 'delete_ordens_servico'] : []); // NOVO

        // CORRIGIDO: Adicionado $estoque e $manutencao
        ...
        unset(
            ...
            $data['permissions_manutencao'] // NOVO
        );
