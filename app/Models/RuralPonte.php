...
class RuralPonte extends Model {
    use HasFactory, SoftDeletes, BelongsToTenant, HasTenantSequentialId;
    protected $table = 'rural_pontes';
    protected $fillable = ['tenant_id', 'sequential_id', 'code', 'rural_localidade_id', 'rural_estrada_id', 'nome_referencia', 'material_construcao', 'capacidade_carga_toneladas', 'estado_conservacao', 'geo'];
    ...
    public function getGeoJsonAttribute() {
        ...
        $result = DB::table('rural_pontes')->select(DB::raw('ST_AsGeoJSON(geo) as geo_json'))->where('id', $this->attributes['id'])->first();
    ...
    public function estrada() { return $this->belongsTo(RuralEstrada::class, 'rural_estrada_id'); }
}