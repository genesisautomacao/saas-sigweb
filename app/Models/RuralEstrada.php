...
class RuralEstrada extends Model {
    use HasFactory, SoftDeletes, BelongsToTenant, HasTenantSequentialId;
    protected $table = 'rural_estradas';
    protected $fillable = ['tenant_id', 'sequential_id', 'code', 'rural_localidade_id', 'nome', 'tipo', 'tipo_pavimento', 'condicao_trafego', 'extensao_geo', 'geo'];
    ...
    public function getGeoJsonAttribute() {
        ...
        $result = DB::table('rural_estradas')->select(DB::raw('ST_AsGeoJSON(geo) as geo_json'))->where('id', $this->attributes['id'])->first();
    ...
    public function pontes() { return $this->hasMany(RuralPonte::class, 'rural_estrada_id'); }
}