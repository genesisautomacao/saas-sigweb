...
class Cemiterio extends Model
{
    ...
    protected $fillable = ['tenant_id', 'sequential_id', 'code', 'name', 'address', 'area_geo', 'geo'];
    ...
    public function getGeoJsonAttribute()
    {
        ...
        $result = DB::table('cemiterios')->select(DB::raw('ST_AsGeoJSON(geo, 6) as geo_json'))
    ...
    public function quadras() { return $this->hasMany(QuadraCemiterio::class); }
    public function logradouros() { return $this->hasMany(LogradouroCemiterio::class); }
}