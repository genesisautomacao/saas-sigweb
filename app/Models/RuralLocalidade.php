...
class RuralLocalidade extends Model
{
    use HasFactory, SoftDeletes, BelongsToTenant, HasTenantSequentialId;

    protected $table = 'rural_localidades';
    ...
    public function getGeoJsonAttribute()
    {
        ...
        $result = DB::table('rural_localidades')
     ...
     * Usamos ST_Multi para garantir que o BD aceite tanto Polygon simples quanto MultiPolygon
     */
