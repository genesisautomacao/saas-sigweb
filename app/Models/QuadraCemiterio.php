...
class QuadraCemiterio extends Model
{
    use SoftDeletes, BelongsToTenant, HasTenantSequentialId;

    protected $table = 'quadras_cemiterio';
    protected $fillable = ['tenant_id', 'sequential_id', 'cemiterio_id', 'code', 'name', 'area_geo', 'geo'];
    ...
    public function getGeoJsonAttribute()
    {
        ...
        $result = DB::table('quadras_cemiterio')->select(DB::raw('ST_AsGeoJSON(geo, 6) as geo_json'))
    ...
    public function jazigos() { return $this->hasMany(Jazigo::class, 'quadra_cemiterio_id'); }
}