...
|--------------------------------------------------------------------------
| O :attribute é substituído pelo rótulo do campo (o Filament envia o label
| do componente — já em português). Sem esta pasta lang/pt_BR, o Laravel
| caía no inglês ("The ... field is required.").
*/
...
return [
    ...
    'uploaded' => 'Falha no envio do arquivo :attribute (verifique o tamanho máximo permitido).',
    ...
    /*
    | Mensagens personalizadas por campo (campo.regra => mensagem)
    */
    'custom' => [],

    /*
    | Nomes amigáveis de atributos (o Filament já envia o label do componente)
    */
    'attributes' => [],
